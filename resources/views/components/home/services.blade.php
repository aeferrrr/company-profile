                ...
                <div class="service-tabs d-flex flex-column h-100 p-4">
                    ...
                    <button class="service-btn active mb-3" onclick="openService(event, 'service1')">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="text-start">
                                <h6 class="mb-0 fw-bold">{{ __('messages.services.civil_name') }}</h6>
                                <small class="text-muted">{{ __('messages.services.civil_sub') }}</small>
                            </div>
                        </div>
                    </button>
                    ...
                    <button class="service-btn mb-3" onclick="openService(event, 'service2')">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="text-start">
                                <h6 class="mb-0 fw-bold">{{ __('messages.services.architecture_name') }}</h6>
                                <small class="text-muted">{{ __('messages.services.architecture_sub') }}</small>
                            </div>
                        </div>
                    </button>
            ...
            <div class="col-lg-8 position-relative bg-dark">
                ...
                <div id="service1" class="service-content active">
                    ...
                    <div class="service-overlay p-5 d-flex flex-column justify-content-end h-100">
                        ...
                        <p class="text-white-50 fs-5">
                            {{ __('messages.services.civil_desc') }}
                        </p>
                    </div>
                </div>
                ...
                <div id="service2" class="service-content">
                    ...
                    <div class="service-overlay p-5 d-flex flex-column justify-content-end h-100">
                        ...
                        <p class="text-white-50 fs-5">
                            {{ __('messages.services.architecture_desc') }}
                        </p>
                    </div>
                </div>
                ...
                {{-- Content 4: Management --}}
                <div id="service4" class="service-content">
                    <img src="{{ asset('images/background/meeting.webp') }}" alt="Management" class="service-bg-img">
                    <div class="service-overlay p-5 d-flex flex-column justify-content-end h-100">
